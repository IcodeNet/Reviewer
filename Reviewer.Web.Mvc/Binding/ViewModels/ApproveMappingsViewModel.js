...
(function (ns) {
    ...
    var vm = function () {
        ...
        self.approveAllRecords = function () {
            ...
            self.viewModelHelper.apiPost("api/operations/approveallrecords",
                null,
                function (result) {
...
$(function () {
  ...
  Note that the aRowids alway contain the ids when header checkbox is checked or unchecked.*/
    ...
    var myGrid = $("#grid").jqGrid({
        ...
        colNames: ["QuestionnaireID", "PC Id", "PC Code", "SE ID", "SE Id", "DT Id", "Has Answers", "BL", "Cluster", "LE", "PCentre", "SE", "Disclosure", "Status", "UserComments", "Approved", ""],
        colModel: [
            ...
            { name: "ClusterName", width: 80, "index": "ClusterName", align: "right" },
