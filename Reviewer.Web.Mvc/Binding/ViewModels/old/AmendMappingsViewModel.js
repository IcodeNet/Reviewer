...
/*
    ...
    function loadGrid() {
        ...
        myGrid = $("#grid").jqGrid({
            ...
            mtype: 'POST',
            url: Reviewer.rootPath + "api/operations/searchnotapprovereturnrecords",
            colNames: ["Id", "HasAnswers", "BL", "Scenario", "LE", "PC Code", "PC", "StructuredEntityId", "SE",  "Disclosure", "Status", "UserComments", "Approved", "PreviousStructuredEntityId", "ProfitCentreId", ""],
            colModel: [
                ...
                { name: "ScenarioName", width: 85, "index": "ScenarioName", sortable: true, align: "right" },
